  ...
  return (
    <div className="min-h-screen flex flex-col">
              ...
              <div className="bg-white pt-8 pb-1 px-2 aspect-[9/19]">
                <div className="bg-gray-100 rounded-lg p-3 mb-3">
                  ...
                  <div className="bg-white rounded p-3 shadow-sm">
                    ...
                    <div className="text-xs">Two filmmakers discuss their next project...</div>
                  </div>
                </div>
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6 bg-gray-50 font-mono text-sm text-gray-800">
                  ...
                  <div className="mb-4">
                    Two directors sit across from each other at a small table. The atmosphere is collaborative and creative.
                  </div>
                  <div className="mb-1 font-bold">DIRECTOR 1</div>
                  <div className="mb-3 text-gray-600">(excitedly)</div>
                  <div className="mb-4">This new AI tool has transformed my workflow completely.</div>
                  <div className="mb-1 font-bold">DIRECTOR 2</div>
                  <div className="mb-3 text-gray-600">(curious)</div>
                  <div>Tell me more about it.</div>
                </div>
              </div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-6">
                ...
                <Link href="/register" className="text-indigo-600 font-medium hover:text-indigo-800">Try it now →</Link>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-br from-indigo-50 to-purple-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-16">What filmmakers are saying</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-indigo-200 flex items-center justify-center text-indigo-700 font-bold mr-4">
                  SJ
                </div>
                <div>
              ...
              <p className="text-gray-700 italic">
                "MAIA's tools have helped me plan out my short film on a tight budget. The scriptwriting assistance is especially incredible."
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Film Student</p>
                </div>
              </div>
              <p className="text-gray-700 italic">
                "As a student, I could never afford professional storyboarding. MAIA makes it possible to visualize my ideas before shooting."
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-blue-200 flex items-center justify-center text-blue-700 font-bold mr-4">
                  AL
                </div>
                <div>
                  <h4 className="font-semibold">Aisha Lee</h4>
                  <p className="text-sm text-gray-600">Production Company Owner</p>
                </div>
              </div>
              <p className="text-gray-700 italic">
                "The budget calculator has transformed how we plan projects. We're now able to provide more accurate quotes to clients."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center">
                <div className="text-2xl font-bold text-white">MAIA</div>
                <div className="ml-2 text-sm text-gray-400">Film Dashboard</div>
              </div>
              <p className="max-w-xs text-gray-400 mt-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="hover:text-white transition-colors">Script Writer</a></li>
                  <li><a href="#" className="hover:text-white transition-colors">Storyboard</a></li>
